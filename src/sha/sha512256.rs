...
//! - digest: 32 bytes
//!
//! SHA-512/256 reuses the SHA-512 compression function with distinct initial
//! constants and returns the first 256 digest bits.
...
/// Stateful SHA-512/256 compressor backed by the SHA-512 state layout.
